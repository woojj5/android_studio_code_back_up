...
import java.lang.String;
 ...
 public class MainActivity extends AppCompatActivity {
     ...
     private final String key = "ZdbB0Zeriv8Nvv8rbJb%2B%2BXwif813ubOy3Kbz696p7EbQJh%2BreDWP341ME00ibmKF3CEqpamX%2FakU98u4KYOwHg%3D%3D";
     private final String endPoint = "openapi.tago.go.kr/openapi/service/BusLcInfoInqireService/";

     //xml 변수
     private EditText xmlBusNum;
     private EditText xmlStationArsno;
     private EditText xmlgetint;
     ...
     public void search(View view) {
         ...
         routeId = xmlBusNum.getText().toString();
         nodeId = xmlStationArsno.getText().toString();
         cityCode = Integer.parseInt(xmlgetint.getText().toString());
...
//         }
     ...
     public void getcitycode() {
         String stationUrl = endPoint + "/getCtyCodeList?serviceKey=" + "&serviceKey=" + key;
         Log.d(TAG, "도시 코드 : " );
                 ...
                 switch (eventType) {
                     ...
                     case XmlPullParser.START_TAG:
                         ...
                         if (tag.equals("item")) ; //첫번째 검색 결과
                             ...
                             xpp.next();
                             cityCode = Integer.parseInt(xpp.getText() ) ;
                         }
...
////     }
     ...
     public void getXmlId() {
         xmlBusNum = findViewById(R.id.nodeid);
         xmlStationArsno = findViewById(R.id.routeid);
         xmlShowInfo = findViewById(R.id.cityCode);
     }
 }
